...
from app.api import waveforms as waveforms_api
...
@pytest.mark.anyio
async def test_waveform_zvs_api_rejects_file_above_size_limit(
    api_client: httpx.AsyncClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(waveforms_api, "MAX_WAVEFORM_FILE_BYTES", 10)
...
@pytest.mark.anyio
async def test_waveform_zvs_api_rejects_sample_limit(
    api_client: httpx.AsyncClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
